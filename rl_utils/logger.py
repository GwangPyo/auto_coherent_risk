"""
logger cherrypicked from stable-baseliens
https://github.com/hill-a/stable-baselines/blob/master/stable_baselines/logger.py
"""
...
KEY_MARK_PATTERN = re.compile("[A-z]+/[A-z]+")
